...
def build_model(input_dim):
  ...
  x = tf.keras.layers.Dense(128, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))(inputs)
  x = tf.keras.layers.Dropout(0.25)(x)
  x = tf.keras.layers.Dense(64, activation='relu',  kernel_regularizer=tf.keras.regularizers.l2(1e-2))(x)
...
#Eleccion del umbral
y_test_probs = model.predict(X_test_s).ravel( )
